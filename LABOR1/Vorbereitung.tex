...
% Dies ist die einfachste Form einer LaTex-Vorlage fÃ¼r den Gebrauch im physikalischen Praktikum I mit einigen Kommentaren. Mit der Zeit kÃ¶nnen Sie diese Vorlage gerne verfeinern oder sich eine andere wÃ¤hlen. Die Kapitel beinhalten teilweise Beispiele wie die Darstellung von Grafiken/Tabellen oder mathematischen Formeln sowie Referenzen/Zitationen. 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\documentclass[a4paper,12pt,bibtotocnumbered]{scrartcl} %Die Dokumentenklasse. In "Word" wÃ¤re das die Dukumentenvorlage
...
\usepackage{tabularx} %Tabellen mit mehr MÃ¶glichkeiten
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\thispagestyle{empty} %Keine Kopf- und FuÃŸzeilen auf dieser Seite
\begin{titlepage}
	\begin{center}
...
\begin{enumerate}
	...
	\item{Dabei erfolgt in jedem explizit synchron getesteten Fall außer dem Reset-Übergang ein Zustandsübergang erst bei der nächsten steigenden Taktflanke}
	\item{Der Reset der Schaltung wird dabei mindestens einmal in einem vom Startzustand verschiedenen Zustand ausgelöst in jedem getesteten Fall asynchron vor der nächsten Taktflanke ausgeführt}
\end{enumerate}
